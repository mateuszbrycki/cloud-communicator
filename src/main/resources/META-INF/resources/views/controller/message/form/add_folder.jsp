    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close add-folder-form-close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="add-folder-modal-title"><spring:message code="folder.add" /></h4>
            </div>
            <form method="PUT" id="add-folder-form" action="${pageContext.request.contextPath}<%=FolderUrls.Api.FOLDER%>/" class="form-horizontal" >
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default add-folder-form-close" data-dismiss="modal"><spring:message code="button.close" /></button>
                    <input type="submit" id="add-folder-submit" value="<spring:message code="folder.button.add" />" class="btn btn-primary"/>
                </div>
            </form>
        </div>
    </div>
