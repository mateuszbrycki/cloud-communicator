    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="PUT" id="send-message-form" action="${pageContext.request.contextPath}<%=MessageUrls.Api.MESSAGE%>/" class="form-horizontal" >
                ...
                <div class="form-group">
                    <label class="control-label col-sm-3" for="topic"><spring:message code="message.modal.topic" />:</label>
                    <div class="col-sm-5">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-3" for="text"><spring:message code="message.modal.text" />:</label>
                    <div class="col-sm-5">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default send-message-form-close" data-dismiss="modal"><spring:message code="button.close" /></button>
                    <input type="submit" id="send-message-submit" value="<spring:message code="message.button.send" />" class="btn btn-primary"/>
                </div>
            </form>
        </div>
    </div>
